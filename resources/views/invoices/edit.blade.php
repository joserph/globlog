...
@section('title') Editar Factura | Sistema de Carguera v1.1 @stop
...
<section class="content-header">
    <div class="container-fluid">
       <div class="row mb-2">
          <div class="col-sm-6">
             <h1>Editar Factura {{ $invoice->num_invoice }}
          ...
          <div class="col-sm-6">
             <ol class="breadcrumb float-sm-right">
                ...
                <li class="breadcrumb-item active">Editar Factura {{ $invoice->num_invoice }}</li>
             </ol>
          </div>
       </div>
    </div><!-- /.container-fluid -->
...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-12">
            <div class="card">
                <div class="card-header">Editar Factura {{ $invoice->num_invoice }}
                </div>
