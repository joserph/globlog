<div class="form-row">
    <div class="form-group col-md-3">
       ...
       <div class="input-group mb-2">
         <div class="input-group-prepend">
           <div class="input-group-text">AWB</div>
         </div>
         {{ Form::text('awb', null, ['class' => 'form-control', 'maxlength' => '13', 'autofocus']) }}
       </div>
    </div>
    {{-- <div class="form-group col-md-3">
    ...
    <div class="col-md-3 form-group">
      {{ Form::label('carrier', 'Transportista', ['class' => 'control-label']) }}
      {{ Form::select('carrier', $airlines, null, ['class' => 'form-control select-product', 'placeholder' => 'Seleccione Aerolinea']) }}
  </div>
    <div class="form-group col-md-3">
   ...
   <div class="form-group col-md-3">
      {{ Form::label('origin_city', 'Ciudad Origen') }}
      {{ Form::text('origin_city', null, ['class' => 'form-control']) }}
   </div>
   <div class="form-group col-md-3">
      {{ Form::label('origin_country', 'País Origen') }}
      ...
      'ZM' => 'Zambia',
      'ZW' => 'Zimbabue'
      ], null, ['placeholder' => 'Seleccione País', 'class' => 'form-control origin_country']) }}
   </div>
   <div class="form-group col-md-3">
      {{ Form::label('destination_city', 'Ciudad Destino') }}
      {{ Form::text('destination_city', null, ['class' => 'form-control']) }}
   </div>
   <div class="form-group col-md-3">
      {{ Form::label('destination_country', 'País Destino') }}
      ...
      'ZM' => 'Zambia',
      'ZW' => 'Zimbabue'
      ], null, ['placeholder' => 'Seleccione País', 'class' => 'form-control destination_country']) }}
   </div>
      @isset($flight)
